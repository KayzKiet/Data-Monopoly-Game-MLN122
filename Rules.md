...
## 2. Tóm Tắt Nhanh Cho Người Mới Chơi

Nếu chỉ cần hiểu nhanh trước khi bắt đầu, hãy nhớ 5 ý:

1. Mỗi người chơi là một chủ thể cạnh tranh trên thị trường.
2. Mục tiêu là mua tài sản, nâng cấp tài sản và tích lũy quyền lực thị trường.
3. Muốn mua tài sản, người chơi thường phải trả lời đúng câu hỏi lý luận.
4. Tài sản dầu mỏ giúp tạo vốn và ảnh hưởng; tài sản dữ liệu giúp tạo người dùng, dữ liệu và lợi thế nền tảng.
5. Người mạnh nhất có thể thắng, nhưng game sẽ đặt câu hỏi: quyền lực đó có tốt cho xã hội không?

Một lượt chơi rất đơn giản: **tung xúc xắc -> di chuyển -> xử lý ô đang đứng -> mua/nâng cấp/trả phí/trả lời câu hỏi nếu có -> kết thúc lượt**.

## 3. Sau Khi Chơi, Người Chơi Hiểu Được Gì?

Sau khi trải nghiệm Data Monopoly, người chơi được kỳ vọng hiểu được:

| Nội dung cần hiểu | Thể hiện trong game |
| --- | --- |
...
Những mục tiêu này giúp game không chỉ là trò chơi cạnh tranh, mà còn là hoạt động học tập có định hướng.
...
Ảnh nhân vật chỉ dùng để phân biệt người chơi trên bàn cờ, không làm thay đổi sức mạnh hay chỉ số ban đầu. Mọi người chơi bắt đầu công bằng với cùng lượng vốn và cùng cơ hội mua tài sản.

Hình ảnh trên các ô giúp người chơi nhận biết nhanh loại tài sản: dầu mỏ, logistics, dữ liệu, cloud, AI, nền tảng số, sự kiện, quiz hoặc điều tiết. Âm thanh tung xúc xắc và nhạc nền chỉ tạo không khí chơi, không ảnh hưởng đến kết quả ván.

Lưu ý nguồn sử dụng: nhạc nền và âm thanh bổ sung được lấy từ Pixabay Music/Pixabay Sound Effects. Khi nộp hoặc chia sẻ công khai, nhóm nên ghi rõ nguồn Pixabay để minh bạch tài nguyên sử dụng.

## 5. Chỉ số của người chơi
...
Ô số 0 là Khởi nghiệp. Người chơi bắt đầu từ ô này, tung xúc xắc để đi quanh bàn cờ. Khi đi hết một vòng và quay lại hoặc đi qua ô Khởi nghiệp, người chơi nhận thêm tiền và mở dần cơ hội nâng cấp tài sản đã mua.
...
- Khởi nghiệp: điểm xuất phát, nhận thêm tiền khi đi qua.
- Tài sản dầu mỏ: mỏ dầu, nhà máy lọc dầu, đường ống, logistics/cảng/kho.
- Tài sản dữ liệu: nền tảng tìm kiếm, mạng xã hội, sàn thương mại điện tử, cloud, phòng thí nghiệm AI.
- Khí vận / Cơ hội: rút thẻ may rủi hoặc thẻ biến động thị trường.
- Câu hỏi lý luận: trả lời câu hỏi để nhận điểm học tập và ảnh hưởng.
- Thuế / Quy định / Khủng hoảng: chịu chi phí, mất ảnh hưởng hoặc bị tác động bởi biến động xã hội.
- Điều tra chống độc quyền: người đang có quyền lực thị trường lớn có thể bị điều tiết.

## 7. Cách chơi mỗi lượt
...
## 12. Tài sản dầu mỏ và tài sản dữ liệu
...
## 15. Ô Thuế, Quy định và Điều trần
...
Điểm này được hiển thị theo thang dễ đọc trên giao diện, thường từ thấp đến cao để người chơi biết ai đang dẫn đầu thị trường.
...
- Đây là cách game gợi mở thảo luận về giới hạn và mâu thuẫn của CNTB hiện đại.
...
## 20. Gợi ý thuyết trình

Khi trình bày trên lớp, có thể giải thích trò chơi theo 5 ý:
